		...
		?>
			<script type="text/javascript">
    			jQuery(document).ready(function($){
    				$.getJSON('http://api.twitter.com/1/statuses/user_timeline.json?include_rts=true&screen_name=<?php echo $zilla_twitter_username; ?>&count=<?php echo $zilla_twitter_postcount; ?>&callback=?', function(tweets){
