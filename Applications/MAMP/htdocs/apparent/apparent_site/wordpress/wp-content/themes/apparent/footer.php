	...
	<div class="footer-outer">
		...
		<div id="footer">
			...
			<p class="copyright">&copy; <?php _e('Copyright ', 'zilla'); echo date( 'Y' ); ?> <a href="<?php echo home_url(); ?>"><?php bloginfo( 'name' ); ?></a> / <?php _e('Powered by', 'zilla') ?> <a href="http://wordpress.org/">WordPress</a></p>
