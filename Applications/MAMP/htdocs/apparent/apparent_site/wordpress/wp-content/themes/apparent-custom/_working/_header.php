...
<body <?php body_class('no-js'); ?>>
    ...
    <div class="header-outer">
		...
		<?php zilla_header_start(); ?>
			...
			<!-- BEGIN #logo -->
			<div id="logo">
				<a href="<?php echo home_url(); ?>"><div class="logo-img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/apparentlogo.png"/></div></a>
			<!-- END #logo -->
			</div>
		...
		<div class="page-header">
			<?php 
				...
				if ( $post->post_parent=="14" || $post->post_parent=="16" ):
					$page_title = get_the_title($post->post_parent);
				endif;

				if( !empty($page_title) && !is_page('home') ) {
