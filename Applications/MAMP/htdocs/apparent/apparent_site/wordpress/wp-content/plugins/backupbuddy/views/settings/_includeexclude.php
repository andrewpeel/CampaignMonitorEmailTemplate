...
if ( $profile > 2 ) {
?>
<a style="float: right; margin-top: -35px; margin-right: 10px;" class="button secondary-button" title="Delete this Profile" href="admin.php?page=pb_backupbuddy_settings&tab=1&delete_profile=<?php echo $profile; ?>" target="_top" onclick="
